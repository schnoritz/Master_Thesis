...
\begin{figure}
    ...
    \caption{Network architeture scheme. Size of the input masks are depicted by width (W), height (H) and depth (D). Input dimensionality is WxHxDx5 and output dimensionality is WxHxDx1.}\label{fig:network}
\end{figure}
